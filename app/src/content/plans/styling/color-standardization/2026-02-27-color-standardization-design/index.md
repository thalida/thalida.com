...
description: The site uses three accent colors (neon, teal, ice) without
  consistent semantic rules. Neon appears on both headings and hover states,
  teal is used for both links and active nav items, and ice is underutilized.
  Users can't reliably tell what's clickable vs what's decorative.
