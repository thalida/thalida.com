...
description: "Redesign the home page content to be compelling and engaging while
  keeping the live-window component. Replace the current minimal hero (\"Work &
  Play\" / \"A creative's catalog\") with three sections: a conversational hero,
  a featured projects strip, and a visual site evolution timeline."
