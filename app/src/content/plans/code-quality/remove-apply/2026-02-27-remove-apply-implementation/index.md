...
description: Replace all `@apply` directives with inline Tailwind utility
  classes on elements, delete separate CSS files, and keep only minimal
  `<style>` blocks for non-inlineable CSS.
