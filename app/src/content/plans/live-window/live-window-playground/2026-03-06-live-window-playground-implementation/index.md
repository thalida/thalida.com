...
description: Create a dev-only interactive playground page with manual controls
  for time, weather, tick speed, and display settings on a single live-window
  component.
