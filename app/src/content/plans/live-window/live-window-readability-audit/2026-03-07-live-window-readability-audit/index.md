...
description: Fix all 85 readability issues (magic numbers, unclear names,
  missing comments, type safety gaps, duplicated logic, stale docs) to make the
  live-window codebase approachable for a junior engineer.
