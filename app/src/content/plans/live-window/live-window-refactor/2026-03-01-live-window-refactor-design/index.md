...
description: Refactor the `<live-window>` web component from a monolithic
  700-line class into focused modules with a `SkyLayer` interface, making it
  easy to add time-aware celestial features (stars, moon, sun) in the future.
