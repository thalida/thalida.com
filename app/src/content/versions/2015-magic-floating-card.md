...
| Year | GitHub | Link |
| ---- | ------ | ---- |
| Jan 2015 - Aug 2016 | [Github](https://github.com/thalida/thalida.com/tree/v-2015) | [Live](https://2015.v.thalida.com) |
...
1. A try at a super minimal site, that gave just enough information to let the visitor know
   what I was all about
2. Create a design with _just_ enough components so that I could rebuild the site in a variety
   of frontend frameworks (as a learning experience)
...
This version of the site was built using [AngularJS](https://angularjs.org/), bower, and gulp.
