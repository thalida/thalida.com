...
category: craft
coverImage: divider-wall/honeycomb-wall-with-decorations.jpeg
coverImageAlt: Floor-to-ceiling 3D-printed gold honeycomb divider wall decorated with colorful flower and geometric panel inserts
---

![Floor-to-ceiling 3D-printed gold honeycomb divider wall decorated with colorful flower and geometric panel inserts](divider-wall/honeycomb-wall-with-decorations.jpeg)
![3D-printed honeycomb divider wall with seasonal snowflake and autumn leaf decorations hanging from the hexagonal grid](divider-wall/honeycomb-wall-seasonal-decor.jpeg)
...
(_I won't do the math on the $$$ I spent on fillament instead of buying lolol_)
