...
description: Implementing Google and Microsoft Azure Active Directory OAuth in
  Django Rest Framework and React Native Expo
...
![Azure API credentials and services page showing OAuth configuration options and API keys settings](/content/guides/django/django-react-native-auth/azure-ad-credentials-api-keys.png)

![Azure AD OAuth 2.0 client configuration form showing authorized JavaScript origins and redirect URIs settings](/content/guides/django/django-react-native-auth/azure-ad-oauth-client-configuration.png)
...
![Microsoft Entra admin center app registrations page with notification about Azure Active Directory feature changes](/content/guides/django/django-react-native-auth/azure-ad-app-registrations.png)

App Registration > New Application

![Azure AD app platform configuration page showing web redirect URIs and authentication settings](/content/guides/django/django-react-native-auth/azure-ad-platform-configuration.png)
...
![Azure AD web redirect URI configuration page for authentication response handling and sign-out redirect settings](/content/guides/django/django-react-native-auth/azure-ad-redirect-uri-configuration.png)
...
![Azure AD API permissions management showing Microsoft Graph permissions with delegated access types and status](/content/guides/django/django-react-native-auth/azure-ad-api-permissions.png)
